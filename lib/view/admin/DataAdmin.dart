...
import 'package:inven_lab/view/admin/EditAdmin.dart';
import 'package:inven_lab/view/admin/TambahAdmin.dart';
...
class _DataAdminState extends State<DataAdmin> {
  ...
  Future<void> _lihatData() async {
    ...
    if (response.contentLength == 2) {
      ...
      data.forEach((api) {
        final ab = new AdminModel(api['no'], api['id_admin'], api['nama'],
            api['username'], api['lvl']);
        list.add(ab);
      });
      setState(() {
        loading = false;
